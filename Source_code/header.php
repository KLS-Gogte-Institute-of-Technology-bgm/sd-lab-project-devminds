...
<title>FineDine Restaurant</title>
<meta charset="utf-8">
...
<!-- <script src='https://kit.fontawesome.com/a076d05399.js'></script>
  <script defer src="https://use.fontawesome.com/releases/v5.0.7/js/all.js"></script>         bootstrap -->
</head>
<style>
.flex-column { 
       max-width : 260px;
...
<nav class="navbar navbar-expand-md navbar-light fixed-top">
		...
		<strong><em>FineDine</em></strong>
            ...
            <div class="collapse navbar-collapse" id="navi">
	            ...
	            <li class="nav-item">
	                <a class="nav-link" href="#gallery">Our speciality</a>
	            </li>
                    <li class="nav-item">
			...
			<li><a class="nav-link fa fa-user-plus" data-toggle="modal" data-target="#myModal_reg">&nbsp;Register</a></li>
          ...
          <div class="modal-content">
            ...
            ?>  
                    ...
                    <form action="includes/login.inc.php" method="post">
                        <center><p class="hint-text">Already a user! Just log in to reserve your table </p></center>
  ...
  <!-- The Modal -->
    <div class="modal fade" id="myModal_reg">
        <div class="modal-dialog">
            ...
            <!-- Modal Header -->
                <div class="modal-header">
                 <h4 class="modal-title">Register</h4> </center>
                  <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>      
            <!-- Modal body -->
                <div class="modal-body">   
    ...
    <!---sign up form -->
                    <div class="signup-form">
                        <form action="includes/signup.inc.php" method="post">
                            <center><p class="hint-text">Create your account soon to book a table!</p></center>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <button type="submit" name="signup-submit" class="btn btn-dark btn-lg btn-block"><a href="#">Register Now</a></button>
                            </div>
                        </form>
