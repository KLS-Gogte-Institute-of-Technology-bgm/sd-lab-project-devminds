...
if(isset($_SESSION['user_id'])){
    echo '<p class="text-white bg-info text-center">Welcome '. $_SESSION['username'] .', Create your reservation here!</p>';
  ...
  //error handling:
    ...
    if(isset($_GET['error3'])){
        ...
        if(isset($_GET['reservation'])) {   
           if($_GET['reservation'] == "success"){ 
            echo '<h4 class="bg-success text-center">Your reservation was successfull!</h4>';
        }
        }
        echo'<br>';
    ...
    <div class="signup-form">
		...
		<option>20:00 - 00:00</option>
            ...
            <div class="form-group">
            <label>Occassion (If any) :</label>
                <textarea class="form-control" name="comments" placeholder="We can surprise you with something according to your occassion !" rows="3"></textarea>
